...
export default function ListeUtilisateur()  {
    ...
    const getAllUtilisateurs = async(num_page) =>{
        console.log("go")
        const {data} = await axios.get('https://irc-o1g5.onrender.com/utilisateur/findAndCountAll/'+num_page)
    ...
    //     try{
    //         const {data} = await axios.delete(`https://irc-o1g5.onrender.com/utilisateur/delete/${id}`)
    //         getAllUtilisateurs()
    //         setAlertDelete(data)
    //     }
    //     catch{
    ...
    // }
    const onDelete = async(id) =>{
         await axios.get(`https://irc-o1g5.onrender.com/utilisateur/delete/${id}`)
        getAllUtilisateurs(0)
    ...
    const onUpdate = async(id) =>{
        ...
        try{
            console.log('a')
            setId(id)
            const {data} = await axios.get(`https://irc-o1g5.onrender.com/utilisateur/findOne/${id}`)
            setUtilisateur(data)
    ...
    const modifierUtilisateur = async () => {
        ...
        const {data} = await axios.post(`https://irc-o1g5.onrender.com/utilisateur/update/${id}`,{
            nom,
            prenom,
            adresse,
            sexe,
